...
public class CvTracker extends Activity {
    ...
    public class myOnItemSelectedListener implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View v, int pos, long row) {
            ...
            CvTracker.this.mPos = pos;
            CvTracker.this.mSelection = parent.getItemAtPosition(pos).toString();
            /*
             * Set the value of the text field in the UI
             */
            // TextView resultText = (TextView)findViewById(R.id.SpinnerResult);
            // resultText.setText(CvTracker.this.mSelection);
        }
    ...
    public boolean readInstanceState(Context c) {
         ...
         */
        this.mPos = p.getInt(POSITION_KEY, CvTracker.DEFAULT_POSITION);
    ...
    public boolean writeInstanceState(Context c) {
        ...
        SharedPreferences p =
                c.getSharedPreferences(CvTracker.PREFERENCES_FILE, MODE_WORLD_READABLE);
